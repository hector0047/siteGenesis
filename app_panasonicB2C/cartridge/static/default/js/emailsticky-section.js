...
/*FArhan's Dev team PANC-1575 04/01/2015 6:50pm*/ 
/*Email Sticky functionality for LPD page*/
                ...
                $(window).bind('DOMContentLoaded load scroll resize orientationchange lockfixed:pageupdate', el, function(e) {
                    ...
                    if (scroll_top >= (el_top - (el_margin_top ? el_margin_top : 0) - config.offset.top)) {
                        ...
                        if (pos_not_fixed) {
                            ...
                            $(".DLP-promotion-mail").addClass("scrollstick");
                        }
                    } else {
                        el.css({
                        ...
                        $(".DLP-promotion-mail").removeClass("scrollstick");
                    }
                });
            }
        }
